...
1. **Check Required Files**:
   ...
   - For web apps: Verify `index.html` has the required **HTML Comment Header** (Author, Description, App Name, Year).
   - For web apps: Verify `index.html` has a version string
...
2. **Update index.html** (Web Apps Only):
   ...
   - Update the version in the HTML Comment Header and title.
